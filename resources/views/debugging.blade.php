...
*/
    ...
    <style>
        #frame-0 .hljs-ln-line[data-line-number='35'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-1 .hljs-ln-line[data-line-number='828'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-2 .hljs-ln-line[data-line-number='118'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-3 .hljs-ln-line[data-line-number='824'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-4 .hljs-ln-line[data-line-number='798'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-5 .hljs-ln-line[data-line-number='778'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-6 .hljs-ln-line[data-line-number='744'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-7 .hljs-ln-line[data-line-number='19'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-8 .hljs-ln-line[data-line-number='47'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-9 .hljs-ln-line[data-line-number='266'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-10 .hljs-ln-line[data-line-number='212'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-11 .hljs-ln-line[data-line-number='808'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-12 .hljs-ln-line[data-line-number='170'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-15 .hljs-ln-line[data-line-number='127'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-20 .hljs-ln-line[data-line-number='201'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-21 .hljs-ln-line[data-line-number='170'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-30 .hljs-ln-line[data-line-number='110'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-32 .hljs-ln-line[data-line-number='62'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-38 .hljs-ln-line[data-line-number='127'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-39 .hljs-ln-line[data-line-number='176'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-40 .hljs-ln-line[data-line-number='145'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-41 .hljs-ln-line[data-line-number='1193'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-42 .hljs-ln-line[data-line-number='17'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-43 .hljs-ln-line[data-line-number='23'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
    </style>
</head>
                ...
                <div class="md:flex md:items-center md:justify-between md:gap-2">
                    ...
                    RelationNotFoundException
                        ...
                        <div
                            ...
                            Call to undefined relationship [posts] on model [App\Models\User].
                        </div>
                    </div>
                    ...
                    GET 127.0.0.1:8000
                        ...
                        <div class="px-4">
                            <span class="text-sm text-gray-500 dark:text-gray-400">PHP 8.2.12 — Laravel 11.38.2</span>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3" x-clock>
                        ...
                        "
                                ...
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Database\Eloquent\RelationNotFoundException</span>
                        ...
                        "
                                ...
                                <span class="inline-flex items-baseline">
                                    ...
                                    <span class="font-mono text-xs">:828</span>
                                </span>
                                                </div>
                                                <div class="text-gray-500 dark:text-gray-400">
                        ...
                        "
                                        >
                                            <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                                                <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Database\Eloquent\Relations\Relation</span>
                        ...
                        "
                                ...
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Database\Eloquent\Builder</span>
                                    <span class="font-mono text-xs">:824</span>
                                </span>
                                                </div>
                                                <div class="text-gray-500 dark:text-gray-400">
                                                    getRelation
                        ...
                        "
                                ...
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Database\Eloquent\Builder</span>
                                    <span class="font-mono text-xs">:798</span>
                                </span>
                                                </div>
                                                <div class="text-gray-500 dark:text-gray-400">
                                                    eagerLoadRelation
                        ...
                        "
                                ...
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Database\Eloquent\Builder</span>
                                    <span class="font-mono text-xs">:778</span>
                                </span>
                                                </div>
                                                <div class="text-gray-500 dark:text-gray-400">
                                                    eagerLoadRelations
                        ...
                        "
                                ...
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Database\Eloquent\Builder</span>
                                    <span class="font-mono text-xs">:744</span>
                                </span>
                                                </div>
                                                <div class="text-gray-500 dark:text-gray-400">
                                                    get
                        ...
                        "
                                        >
                                            <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                                                <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">App\Http\Controllers\Api\UserController</span>
                        ...
                        "
                                        >
                                            <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                                                <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\public\index.php</span>
                        ...
                        "
                                        >
                                            <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                                                <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Foundation\resources\server.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Database\Eloquent\RelationNotFoundException.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Database\Eloquent\Builder.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Database\Eloquent\Relations\Relation.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\app\Http\Controllers\Api\UserController.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Routing\ControllerDispatcher.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Routing\Route.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Routing\Router.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Pipeline\Pipeline.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Routing\Middleware\SubstituteBindings.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Foundation\Http\Kernel.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Foundation\Http\Middleware\TransformsRequest.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Foundation\Http\Middleware\ConvertEmptyStringsToNull.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Foundation\Http\Middleware\TrimStrings.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Http\Middleware\ValidatePostSize.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Foundation\Http\Middleware\PreventRequestsDuringMaintenance.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Http\Middleware\HandleCors.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Http\Middleware\TrustProxies.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Foundation\Http\Middleware\InvokeDeferredCallbacks.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Foundation\Application.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\public\index.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">C:\laragon\www\berbagirasa-api\vendor\laravel\framework\src\Illuminate\Foundation\resources\server.php</span>
...
require_once $publicPath.&#039;/index.php&#039;;
            ...
            <section
                ...
                <div class="mt-2">
                    <span>GET</span>
                    <span class="text-gray-500">/api/users</span>
                </div>
                ...
                <dl class="mt-1 grid grid-cols-1 rounded border dark:border-gray-800">
                    ...
                    "
                        >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">612398fa-5526-4091-898c-ba0c6486c985</code></pre>
                </span>
                    </div>
                    <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
            ...
            <section
                ...
                <dl class="mt-1 grid grid-cols-1 rounded border dark:border-gray-800">
                    ...
                    "
                        >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">App\Http\Controllers\Api\UserController@index</code></pre>
                </span>
                    </div>
                    <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
                    ...
                    "
                        >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">users.index</code></pre>
                </span>
                    </div>
                    <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
                ...
                <dl class="mt-1 grid grid-cols-1 rounded border dark:border-gray-800">
                    <div class="flex items-center gap-2  dark:border-gray-800">
                        <div
                            ...
                            <span>mysql</span>
                            <span class="hidden text-xs text-gray-500 lg:inline-block">(2.81 ms)</span>
                        </div>
                        <span
                            class="min-w-0 flex-grow"
                            style="
                    ...
                    "
                        >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">select * from `users`</code></pre>
                </span>
                    </div>
                </dl>
            </section>
